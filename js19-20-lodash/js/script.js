...
// console.log (q1);
q1 = q1.reduce(function(flat, current) { return flat.concat(current); }, []);
...
q3 = q3.reduce(function(flat, current) { return flat.concat(current); }, []);
q3 = _.uniq(q3);
...
q2 = _.zip(q2, s);
q2 = _.sortBy(q2);
q2 = q2.reduce(function(flat, current) { return flat.concat(current); }, []);
